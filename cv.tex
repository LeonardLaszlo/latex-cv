...
\newcommand{\printaside}{\begin{aside}
  ...
  \section{Leonard László}\\
    \href{https://goo.gl/maps/hmDQ8qNK5KMDU4kh9}{8134 Adliswil,\\Switzerland}
\end{aside}}

\begin{document}
\header{Leonard}{László}{Senior Computer Engineer}
\printaside%
